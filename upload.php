...
<head>
    ...
    <style>
        ...
        /* Navbar Styles */
        .navbar {
            background-color: #0074d9; /* Navbar background color */
            padding: 10px;
            color: white;
            text-align: center;
        }
        ...
        .delete-button:hover, .upload-button:hover {
...
<body>
    ...
    <div class="container">
        <h1><i class="fa fa-upload icon"></i> Upload Coffee Data</h1>
        <form action="upload.php" method="post" enctype="multipart/form-data">
            <label for="file">Choose Excel file:</label>
            <input type="file" name="file" id="file" accept=".xlsx,.xls">
            <button type="submit" class="upload-button"><i class="fa fa-upload"></i> Upload</button>
            <button type="submit" name="delete" class="delete-button" onclick="confirmDelete(event)"><i class="fa fa-trash"></i> Delete All Data</button>
            <input type="hidden" name="confirm_delete" value="true">
        </form>

        <h2><i class="fa fa-database icon"></i> Data from Database</h2>
        <table>
            <tr>
                <th>S.N</th>
